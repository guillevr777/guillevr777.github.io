...
CREATE TABLE TRABAJA (
	...
	ADD	CONSTRAINT CHECK CK_TEMPERATURA (TEMPERATURA BETWEEN 32.5 AND 44)
		CONSTRAINT CHECK CK_NUMEROINTERMEDIO (NUMEROINTERMEDIO % 2 == 0 && NUMEROINTERMEDIO < 1000*100 && NUMEROINTERMEDIO > 1000)
		CONSTRAINT CHECK CK_NUMEROGRANDE (NUMEROGRANDE > 1000*100)
		CONSTRAINT CHECK CK_NUMEROPIE (NUMEROPIE BETWEEN 25 AND 60)
		CONSTRAINT CHECK CK_NUMEROCHICO (NUMEROCHICO < 1000)
		CONSTRAINT CHECK CK_NIVELINGLES (NIVELINGLES IN ('A0''A1''A2''B1''B2''C1''C2') 