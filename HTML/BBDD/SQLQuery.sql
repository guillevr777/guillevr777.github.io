...
CREATE TABLE TRABAJA (
	...
	CREATE TABLE TIPOS (
	Id SMALLINT CONSTRAINT PK_TIPOS PRIMARY KEY,
	Nombre VARCHAR(15) CONSTRAINT UQ_TIPOS UNIQUE,
	NumPelos INT Not Null,
	TipoRopa char(1) Not Null,
	NumSuerte TinyInt Not Null,
	Minutos TinyInt Not Null
	)

	ALTER TABLE TIPOS
		ADD CONSTRAINT CK_ID CHECK(Id % 2 != 0),
		 CONSTRAINT CK_NUMPELOS CHECK(NumPelos BETWEEN 0 AND 150.000),
		 CONSTRAINT CK_TIPOROPA CHECK(TipoRopa IN ('C','F','E','B','P','N')),
		 CONSTRAINT CK_NUMSUERTE CHECK(NumSuerte % 3 = 0 AND NumSuerte BETWEEN 10 AND 40),
	...
	CREATE DATABASE EJEMPLOSRESTRICCIONES
