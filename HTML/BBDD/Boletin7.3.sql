...
SELECT au_lname,au_fname,address,city,state,zip FROM authors where au_lname not like ('D%') AND au_lname not like ('G%') AND au_lname not like ('S%');
...
INSERT INTO titles VALUES ('GU1042','Ivan es un poco autista','psychology',0777,0.99,15000,45,10000,'its about the atopic of the autism',CURRENT_TIMESTAMP);
